...
// Writer version
constexpr std::string_view WRITER_NAME_KEY{"orc.writer.name"};
constexpr std::string_view WRITER_VERSION_KEY{"orc.writer.version"};
constexpr std::string_view WRITER_HOSTNAME_KEY{"orc.writer.host"};
